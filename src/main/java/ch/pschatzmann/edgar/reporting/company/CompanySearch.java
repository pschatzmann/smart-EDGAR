 ...
 *
 */
public class CompanySearch implements ICompanyInfoResult {
	...
	public String toCsv() throws FormatException,  DataException {
		setup();
		return new TableFormatterCSV().format(table);
	}

	public String toHtml() throws FormatException,  DataException {
		setup();
		return new TableFormatterHtml().format(table);
	}

	public String toJson() throws FormatException,  DataException {
		setup();
